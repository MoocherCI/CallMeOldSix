...
sudo ufw allow proto tcp from [REDACTED] to any port 80
sudo ufw allow proto tcp from [REDACTED] to any port 443
sudo ufw allow proto tcp from [REDACTED] to any port 3100
