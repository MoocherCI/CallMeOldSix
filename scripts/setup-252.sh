...
sudo ufw allow proto tcp from 192.168.11.0/24 to any port 5432
sudo ufw allow proto tcp from 192.168.11.0/24 to any port 6379
sudo ufw allow proto tcp from 192.168.11.0/24 to any port 3000:3005
